...
CREATE (e1:Employee { first_name: 'Jan', last_name: 'Kowalski', age: 35, uuid: randomUUID() })
CREATE (e2:Employee { first_name: 'Anna', last_name: 'Nowak', age: 28, uuid: randomUUID() })
CREATE (e3:Employee { first_name: 'Piotr', last_name: 'Zieliński', age: 32, uuid: randomUUID() })
CREATE (e4:Employee { first_name: 'Maria', last_name: 'Wójcik', age: 30, uuid: randomUUID() })
CREATE (e5:Employee { first_name: 'Robert', last_name: 'Lewandowski', age: 37, uuid: randomUUID() })
CREATE (e6:Employee { first_name: 'Jac', last_name: 'Muchowski', age: 52, uuid: randomUUID() })
CREATE (e7:Employee { first_name: 'Aleksandra', last_name: 'Kowalska', age: 22, uuid: randomUUID() })
CREATE (e8:Employee { first_name: 'Tomasz', last_name: 'Smok', age: 29, uuid: randomUUID() })
CREATE (e9:Employee { first_name: 'Sławomir', last_name: 'Piątek', age: 33, uuid: randomUUID() })
CREATE (e10:Employee { first_name: 'Jacek', last_name: 'Soplica', age: 41, uuid: randomUUID() })
